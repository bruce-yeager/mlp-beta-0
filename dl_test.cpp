...
#include <sys/stat.h>
#include <unistd.h>
// #include <mpi.h>  // Not needed for launcher.py approach
...
//         DataLoaderLite loader(B, T, rank, world, split, data_root, master);

//         // Get one batch (per rank)
//         Batch batch = loader.next_batch();

//         std::cout << "rank " << rank << " got batch: "
//                   << "x[0]=" << batch.x.size() << " y[0]=" << batch.y[0]
//                   << " (B=" << batch.B << ", T=" << batch.T << ")\n";
//         MPI_Finalize();
//         std::cin.get();
//         return 0;
...
//mpic++ -O3 -std=c++17 dataloader_test.cpp -o dataloader -lmpi -L/usr/lib/x86_64-linux-gnu/openmpi/include -L/usr/lib/x86_64-linux-gnu/openmpi/lib -fopenmp

// g++ -O3 -std=c++17 dataloader_test.cpp -o dataloader -lmpi_cxx -I/usr/local/cuda/targets/x86_64-linux/include -L/usr/local/cuda/lib64  -I/usr/lib/x86_64-linux-gnu/openmpi/include -L/usr/lib/x86_64-linux-gnu/openmpi/lib -I/home/blubridge-035/Desktop/Backup/parallelism/DataLoaderLite/Tensor-Implementations/include/ -L/home/blubridge-035/Desktop/Backup/parallelism/DataLoaderLite/Tensor-Implementations/lib/ -lmpi  -ltbb -fopenmp -ltensor -lpthread -lcudart